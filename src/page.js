/*
  Copied from phantom-html-to-pdf/lib/scripts/serverScript.js and added the PDF zoom fix toward the bottom
*/
...
page.open(body.url, function () {
    ...
    if (body.applyPDFZoomFix) {
      // pdf zoom fix: https://github.com/ariya/phantomjs/issues/12685#issuecomment-90912119
        var zoom = 0.68;
